		    ...
		    <c:forEach var="acc" items="${account}">
			  <div class="card">
			    <div class="additional">
			      ...
			      <div class="more-info">
			        <h1><a href="/banking/account/transfer_account?aid=${acc.aid}&accType=${acc.accType}" class="in-btn">이체하기</a></h1>
			        <div class="coords">
			    ...
			    <div class="general">
			      <h1>${acc.accountNum}</h1>
			      <h2>${acc.balance}</h2>
			      <a href="/banking/account/transfer_account?aid=${acc.aid}&accType=${acc.accType}" class="in-btn">이체하기</a>
